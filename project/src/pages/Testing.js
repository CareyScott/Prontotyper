// inactive page used for integration and system testing purposes
...
const Testing = (props, leftPosition) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://pronto-api-rest.azurewebsites.net/predict/${"Sketch1.jpg"}/container/${"new"}`,
        {
          headers: {
